...
// this will remove the path of both \ and /
...
NDSERR inline bool escape_string(std::string& output_string, std::string_view input_string)
{
...
NDSERR inline bool rem_escape_string(char* input_string)
{
	int i = 0;
	int j = 0;
